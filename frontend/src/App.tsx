...
function Header({ page, cartCount, go }: { page: Page; cartCount: number; go: (page: Page) => void }) {
  return <header className="site-header">
    <button className="brand" onClick={() => go('home')} aria-label="Ir al inicio"><span className="brand__mark">PA</span><span><strong>Pan Artesano</strong><small>Horneado con cariño</small></span></button>
